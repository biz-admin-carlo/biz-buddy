    ...
    <>
      ...
      <div className="profile-info-container">
        <div style={{ width: '30%', maxWidth: '200px' }}>
          ...
          <ProfileInfo label="Basic Pay" value={'-'} />
          <ProfileInfo label="Campaign" value={'Chess Builders'} />
          <ProfileInfo label="Employment Status" value={'Probationary'} />
          <ProfileInfo label="Work Setup" value={'Work From Home'} />
        </div>
      </div>
